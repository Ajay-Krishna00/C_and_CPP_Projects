...
int main()
{
  ...
  Process processes[] = {
      {2, 5, 2}, // Arrival time = 1, Burst time = 1
      {4, 0, 3}, // Arrival time = 3, Burst time = 2
      {5, 4, 4}, // Arrival time = 4, Burst time = 6
      {3, 1, 8}, // Arrival time = 2, Burst time = 3
      {1, 2, 6}, // Arrival time = 0, Burst time = 8
  };
